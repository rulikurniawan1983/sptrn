<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-sm-row mb-4 gap-2">
            ...
            <li class="nav-item">
                <a class="nav-link {{ @$isLock == true ? 'disabled' : null }} {{ @$activeTab == 'Praktek Dokter Hewan Berkas' ? 'active' : ($isLock == false ? 'bg-light border' : '') }}"
                    href="{{ @$item->id ? route($route . '-berkas.index', ['id_praktek_dokter_hewan' => $item->id]) : null }}">
                    Berkas</a>
            </li>
            {{-- <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ @$isLock == true ? 'disabled' : null }} {{ @$activeTab == 'Praktek Dokter Hewan Galeri' ? 'active' : ($isLock == false ? 'bg-light border' : '') }}"
                    href="{{ @$item->id ? route($route . '-galeri.index', ['id_praktek_dokter_hewan' => $item->id]) : null }}">
                    Galeri</a>
            </li>
            <li class="nav-item">
