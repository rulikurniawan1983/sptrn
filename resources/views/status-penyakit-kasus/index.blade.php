...
@section('content')
    <x-tab-status-penyakit-component :item="$getParent" :active-tab="$titlePage" :is-lock="false" />
    <div class="card shadow-sm">
        @include('base-page.header-index', [
            'routeAddCustom' => route("$route.create", ['id_status_penyakit' => $getParent->id]),
        ...
        $(document).ready(function() {
            table = $('#DataTable').DataTable({
                ...
                'ajax': {
                    ...
                    type: "POST",
                    data: function(d) {
                        d.id_status_penyakit = "{{ $getParent->id }}";
                    },
                ...
                "columns": [{
                    ...
                    {
                        "data": "status_penyakit_hewan.nama_hewan",
                    },
                    {
                        "data": "jumlah_terinfeksi",
                    },
                    {
                        "data": "jumlah_sembuh",
                    },
