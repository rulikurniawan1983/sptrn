...
<div class="row mb-3">
    <label class="col-md-4 col-form-label">Jumlah Kolam</label>
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-6">
                <x-form-input type="text" name="jumlah_kolam" autofocus :use-label="false" class="form-control numeral-mask" />
            </div>
            <div class="col-md-6">
                <x-form-select name="jumlah_kolam_id_satuan" :use-label="false" placeholder="Pilih Satuan" :options="$listSatuan"/>
            </div>
        </div>
    </div>
</div>
