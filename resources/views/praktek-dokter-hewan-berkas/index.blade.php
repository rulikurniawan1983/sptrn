...
@section('content')
    ...
    <div class="card shadow-sm">
        @include('base-page.header-index', [
            'routeAddCustom' => route("$route.create", ['id_praktek_dokter_hewan' => $getParent->id]),
        ...
        $(document).ready(function() {
            table = $('#DataTable').DataTable({
                ...
                'ajax': {
                    ...
                    type: "POST",
                    data: function(d) {
                        d.id_praktek_dokter_hewan = "{{ $getParent->id }}";
                    },
