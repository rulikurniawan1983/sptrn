            ...
            <div class="card shadow-sm">
                <div class="card-header border-bottom py-3 d-md-flex justify-content-between align-items-center">
                    ...
                    <div class="mt-2 mt-md-0">
                        <a href="{{ @$backroute ? @$backroute : route("$route.index", ['id_upt_puskeswan' => $getParent->id]) }}" class="btn btn-secondary">
                ...
                <div class="card-body pt-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            {{ html()->hidden('id_upt_puskeswan', $getParent->id) }}
...
<script>
    ...
    doc_upload.on("sending", function(a, b, c) {
        ...
        c.append("id_upt_puskeswan", $('[name=id_upt_puskeswan]').val());
        c.append("id_jenis_galeri", $('[name=id_jenis_galeri]').val());
        c.append("nama", $('[name=nama]').val());
    });

    doc_upload.on("queuecomplete", function(file) {
        window.location.href = "{{ url($route) }}?id_upt_puskeswan=" + $("[name=id_upt_puskeswan]").val();
    });
