...
class PeternakanFormatExport implements FromCollection, WithHeadings, WithMapping, WithEvents, WithColumnFormatting
{
    /**
    ...
    */
    public function collection()
    {
        return collect([
            [
                "nama" => "Sapi Berkah Mandiri",
                "kode_kbli" => "01411",
                "kode_jenis_usaha" => "1",
                "kode_jenis_peternakan" => "1",
                "kode_kecamatan" => "1",
                "kode_kelurahan" => "79",
                ...
                "website" => "www.peternakanberkahmandiri.com",
    ...
    public function map($transaction): array
    {
        return [
            ...
            $transaction['kode_jenis_peternakan'],
