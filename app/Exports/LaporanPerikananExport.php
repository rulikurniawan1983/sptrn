...
class LaporanPerikananExport implements FromCollection, WithHeadings, WithMapping, WithEvents
{
    protected $data;
    ...
    public function map($transaction): array
    {
        $data = [
            ...
            $transaction->jenis_perikanan->nama,
            ...
            $transaction->jenis_kelamin_kode,
