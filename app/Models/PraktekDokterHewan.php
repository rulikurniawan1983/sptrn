...
class PraktekDokterHewan extends Model
{
    use HasFactory, Blameable, SoftDeletes, LogsActivity;
    
    protected $guarded = [];
    protected $table = "praktek_dokter_hewan";
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['*'])
            ->logOnlyDirty()
            ->setDescriptionForEvent(fn (string $eventName) => "Praktek Dokter Hewan");
    }
    ...
    public function jenis_keswan() {
        return $this->belongsTo(MstJenisPeternakan::class, 'id_jenis_keswan')->withDefault(['nama' => null]);
    }
    ...
    {
        return $this->morphMany(Galeri::class, 'modelable');
    }
    // Todo: End Relation
