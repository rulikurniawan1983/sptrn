...
class Peternakan extends Model
{
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['*'])
            ->logOnlyDirty()
            ->setDescriptionForEvent(fn (string $eventName) => "Peternakan");
    }
    ...
    public function jenis_peternakan() {
        return $this->belongsTo(MstJenisPeternakan::class, 'id_jenis_peternakan')->withDefault(['nama' => null]);
    }
